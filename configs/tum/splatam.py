...
# scenes = ["freiburg3_sitting_halfsphere", "freiburg3_sitting_xyz", "freiburg3_walking_static", "freiburg3_walking_xyz"]

# nohup python scripts/splatam.py configs/tum/splatam.py &
