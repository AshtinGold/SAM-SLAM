...
seed = int(6)
scene_name = scenes[int(0)] ## change this
...
config = dict(
    ...
    report_global_progress_every=100, # Report Global Progress every nth frame # CHANGE 500
    eval_every=100, # Evaluate every nth frame (at end of SLAM) # CHANGE 500
    ...
    tracking=dict(
        ...
        use_chamfer=False,
        loss_weights=dict(  ## different for every dataset
            im=0.5,
            depth=1.0,
            sem_im = 0.5
        ),
