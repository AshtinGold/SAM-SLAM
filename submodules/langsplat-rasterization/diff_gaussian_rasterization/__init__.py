...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, feat_s, feat_m, feat_l, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
            ...
            num_rendered, color, feat_s, feat_m, feat_l, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
            language_feature = [feat_s, feat_m, feat_l]

        # Keep relevant tensors for backward
        ctx.raster_settings = raster_settings
        ctx.num_rendered = num_rendered
        ctx.save_for_backward(colors_precomp, language_feature_precomp, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer)  # note the precomp variables are UNCHANGED throughout the process
