...
class ReplicaDataset(GradSLAMDataset):
    ...
    def get_filepaths(self):
        ...
        #>>
        s_paths = natsorted(glob.glob(f"{self.input_folder}/language_features_dim3/*_s.npy"))
        f_paths = natsorted(glob.glob(f"{self.input_folder}/language_features_dim3/*_f.npy"))
